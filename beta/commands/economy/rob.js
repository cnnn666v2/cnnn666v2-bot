...
$color[GREEN]
$title[You successfully robbed $username[$mentioned[1]]]
$footer[Risky man]
$addTimestamp
...
$description[You stole $random[5;$getGlobalUserVar[Money;$mentioned[1]]] :pound: from $username[$mentioned[1]]]

$elseif[$randomText[lose;lose;win]==lose]
$color[RED]
$title[You got caught while robbing $username[$mentioned[1]]]
$footer[Robbing bad]
$addTimestamp

$setGlobalUserVar[Money;$sub[$getGlobalUserVar[Money;$authorID];$random[5;$getGlobalUserVar[Money;$authorID]]];$authorID]
$description[You got caught and paid $random[5;$getGlobalUserVar[Money;$authorID]] :pound: fine]

$endelseif
$endif

$globalCooldown[1d;:x: You can rob 1 person every day. Try to rob someone again in %time%]
$onlyIf[$getGlobalUserVar[Money]>2499;:x: You need at least 2500 :pound: to rob someone!]
